...
export const IndexAboutUs = (props) => {
  return (
    <>
    <section id="about-us">
          ...
          <div className="container">
            ...
            <div className="about-us-top row">
              <div className="col-lg-6 about-us-img">
                <img
                  src="/assets/images/ve-chung-toi/ve-chung-toi.jpg"
              ...
              <div className="col-lg-6">
                <div className="about-us-right ml-5">
                  ...
                  <p>
                    Nội thất <b>Hoàng Hoan</b> chúng tôi tự hào là đứa con
                    tinh thần ra đời sau hơn 30 năm hoạt động trong lĩnh vực
                    kinh doanh đồ gỗ nội thất với thương hiệu
                  ...
                  <p>
                    ...
                    nghiệp ĐH Kiến Trúc Hà Nội với nhiều năm kinh nghiệm, luôn
                  ...
                  <div>
                    <div className="about-us-imgs row">
                      <div className="about-us-img col-lg-3">
                        <img
                          src="/assets/images/ve-chung-toi/ve-chung-toi-1.jpg"
                          alt="ve-chung-toi-1.jpg"
                        />
                      </div>
                      <div className="about-us-img col-lg-3">
                        <img
                          src="/assets/images/ve-chung-toi/ve-chung-toi-2.jpg"
                          alt="ve-chung-toi-2.jpg"
                        />
                      </div>
                      <div className="about-us-img col-lg-3">
                        <img
                          src="/assets/images/ve-chung-toi/ve-chung-toi-3.jpg"
                      ...
                      <div className="about-us-img col-lg-3">
                        <a href="#">Xem thêm &gt;</a>
                        <img
                          src="/assets/images/ve-chung-toi/ve-chung-toi-4.jpg"
            ...
            <div className="d-flex justify-content-between flex-lg-wrap-reverse">
              <div className="item-about-us d-flex py-2 mb-4">
                <div className="icon-about-us d-flex justify-content-center flex-column px-3">
                  <img
                    src="/assets/images/ve-chung-toi/chinh-sach.jpg"
                    alt="chinh-sach.jpg"
                  />
                </div>
              ...
              <div className="item-about-us d-flex py-2 mb-4">
                <div className="icon-about-us d-flex justify-content-center px-3">
                  <img
                    src="/assets/images/ve-chung-toi/san-pham.jpg"
                    alt="san-pham.jpg"
                  />
                </div>
                <div className="title-item-about-us d-flex justify-content-center flex-column">
...
export default connect(mapStateToProps, mapDispatchToProps)(IndexAboutUs)