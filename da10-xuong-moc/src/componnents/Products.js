        ...
        <div className="col-lg-4 ket-noi">
          ...
          <ul className="d-flex">
            <li className="d-flex flex-column justify-content-center">
              <a href="#">
                <img
                  src="../DA10-XuongMoc/images/icon-facebook.png"
                  alt="zalo-facebook"
                />
              </a>
            </li>
            <li className="d-flex flex-column justify-content-center">
              <a href="#">
                <img
                  src="../DA10-XuongMoc/images/icon-zalo.png"
                  alt="zalo-icon"
                />
              </a>
            </li>
            <li className="d-flex flex-column justify-content-center">
              <a href="#">
                <img
                  src="../DA10-XuongMoc/images/icon-mail.png"
                  alt="zalo-mail"
                />
              </a>
            </li>
          ...
          <div className="icon-da-thong-bao">
            <img src="../DA10-XuongMoc/images/icon-da-thong-bao.png" alt="" />
          </div>
        </div>
      </div>
    </div>
